...
const Login = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (Object.keys(newErrors).length === 0) {
      // Mock authentication
      const userData = {
        name: formData.email === 'admin@rechargehub.com' ? 'Admin User' : 'John Doe',
        email: formData.email,
        role: formData.email === 'admin@rechargehub.com' ? 'admin' : 'user'
      };
      ...
      <div className="max-w-md w-full space-y-8">
        <div className="card">
          ...
          <div className="mt-4 p-4 bg-gray-50 rounded-lg">
            ...
            <p className="text-xs text-gray-500">Admin: admin@rechargehub.com / password123</p>
            <p className="text-xs text-gray-500">User: user@example.com / password123</p>
          </div>
        </div>
      </div>
    </div>
