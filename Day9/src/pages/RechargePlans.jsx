...
import { Search, Filter, Smartphone, Clock, Wifi, Phone, MessageSquare, Star } from 'lucide-react';
import { useApp } from '../context/AppContext';

const RechargePlans = () => {
  const { plans, addRecharge, user } = useApp();
  ...
  const filteredPlans = plans.filter(plan => {
    ...
    if (selectedFilter === 'budget') return matchesSearch && plan.price <= 199;
    if (selectedFilter === 'premium') return matchesSearch && plan.price >= 300;
